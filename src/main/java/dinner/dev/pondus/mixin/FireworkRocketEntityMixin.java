...
public abstract class FireworkRocketEntityMixin extends Entity {
    ...
    public Direction gravitychanger$getAppliedGravityDirection() {
        ...
        return PondusAPIFabric.getGravityDirection((FireworkRocketEntity)(Object)this);
    }*/
    @ModifyVariable(
        method = "tick()V",
        at = @At(
    ...
    public Vec3 tick(Vec3 value) {
        if (attachedToEntity != null) {
            value = RotationUtil.vecWorldToPlayer(value, PondusAPI.getGravityDirection(attachedToEntity));
        }
        return value;
    }
